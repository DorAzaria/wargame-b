...
//			 Add soldiers for player 2:
            ...
            board[{6,7}] = new ParamedicCommander(2);

			board[{7,3}] = new FootCommander(2);
			board[{1,2}] = new FootSoldier(2);
            board[{6,1}] = new FootSoldier(2);
		...
		uint DemoGame::play() {
            ...
            board.move(2, {6,7}, Board::MoveDIR::Up);      // FootSoldier of player 1 moves forward and attacks from {0,1} to {1,1}.
            if (!board.has_soldiers(2)) return 1;
            ...
            board.move(1, {1,3}, Board::MoveDIR::Left);      // FootCommander of player 1 moves forward from {0,3} to {1,3}, and all soldiers of player 1 attack.
            if (!board.has_soldiers(2)) return 1;

            board.move(1, {0,4}, Board::MoveDIR::Up);      // FootCommander of player 1 moves forward from {0,3} to {1,3}, and all soldiers of player 1 attack.
            if (!board.has_soldiers(2)) return 1;
